...
class LLMInterface:
    ...
    def __init__(self, config: dict[str, Any]):
        ...
        llm_config = LLMConfig(
            ...
            model_path=config.get("llm", {}).get("model_path", "microsoft/DialoGPT-medium"),
    ...
    def format_prompt(self, query: str, context: str) -> str:
        ...
        template = self.prompts.get("query_template",
    ...
    def generate_answer(self, query: str, query_result: QueryResult) -> LLMResponse:
        ...
        if not query_result.chunks:
            ...
            no_answer_template = self.prompts.get("no_answer_template",
        ...
        for chunk in query_result.chunks:
            context_parts.append(f"[Document: {chunk.metadata.file_name}, Page: {chunk.metadata.page_number}]\n{chunk.text}")
        ...
        logger.info(f"Used {response.prompt_tokens} prompt tokens, {response.response_tokens} response tokens")
...
def generate_answer_from_query(query: str, query_result: QueryResult, config: dict[str, Any]) -> str:
    """
